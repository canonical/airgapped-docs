...
project = "Airgapped documentation"
...
html_context = {
    ...
    "mattermost": "https://chat.canonical.com/canonical/channels/airgapped",
    ...
    "github_url": "https://github.com/canonical/airgapped-docs",
    ...
    "license": {
        ...
        "url": "https://github.com/canonical/airgapped-docs/blob/main/LICENSE",
    },
}
...
llms_txt_description = textwrap.dedent(
    """\
    This documentation provides guidance for deploying and maintaining 
    Ubuntu and other Canonical products in airgapped environments.
    """
)
...
linkcheck_ignore = [
    # sphinx-stack recommended ignores:
    "http://127.0.0.1:8000",
    "https://github.com",
    r"https://matrix\.to/.*",
    "https://example.com",
...
# BJDEAN TODO: check if this workaround is still needed
